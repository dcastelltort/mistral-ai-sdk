...
use mistral_ai_sdk::{MistralClient, api::classifications::{ClassificationsApi, ClassificationRequest, ClassificationInput, ChatClassificationRequest, ChatMessage}};
use serde_json::json;
